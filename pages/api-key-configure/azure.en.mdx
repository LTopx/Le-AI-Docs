...
After creating the Resource Name and Deployments, you can configure them on Le-AI. Le-AI provides three commonly used versions of Azure OpenAI models: gpt-3.5/gpt-4/gpt-4 32k. You just need to fill in your named Deployname in the corresponding version.
