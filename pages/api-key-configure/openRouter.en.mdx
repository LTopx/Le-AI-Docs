...
In Le-AI, this setting has been simplified to only three modes to choose from: Deterministic/Neutral/Randomness. You can adjust this parameter according to your needs.

### Max Tokens

> Since the maximum token limit for PaLM models in OpenRouter is set at 1025, it is temporarily limited to 1025 in Le-AI as well.
