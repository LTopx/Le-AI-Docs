...
Currently, all environment variable configurations of L-GPT are **optional**, which means it can still function properly without any configuration. Different environment variable configurations can achieve different functionalities.
