...
<Image
  className="w-[1034px]"
  src="/change-log/v0.9.2-zh-CN.png"
  alt="v0.9.2"
  width={1034}
  height={1528}
/>
...
<Image
  className="w-[1034px]"
  src="/change-log/v0.9.1-1-zh-CN.png"
  alt="v0.9.1-1"
  width={758}
  height={1068}
/>
...
<div className="font-bold mt-6 text-emerald-500">
  终于推出了 Le-AI 客户端版本。目前支持 Windows, Mac
  平台。无用户系统，支持配置在系统内生成的 Le-AI API Key 或支持的其他模型 API
  Key 使用，例如 OpenAI、Azure OpenAI、OpenRouter 等。
</div>

[点击了解更多](http://localhost:3000/zh-CN/change-log)
...
<Image
  src="/change-log/v0.8.4-1-zh-CN.png"
  alt="Cloud Sync"
  width={1034}
  height={1034}
/>
...
<Image
  src="/change-log/v0.8.3-1-zh-CN.png"
  alt="Project link"
  width={1300}
  height={731}
/>
...
- 添加跳转 [Le-AI 文档链接](https://docs.le-ai.app/zh-CN)
