...
<Image
  className="w-[1034px]"
  src="/change-log/v0.9.1-1-en.png"
  alt="v0.9.1-1"
  width={758}
  height={1068}
/>
...
<div className="font-bold mt-6 text-emerald-500">
  Finally, the Le-AI client version has been released. Currently, it supports
  Windows and Mac platforms. There is no user system, but it supports
  configuring the Le-AI API Key generated within the system or supported API
  Keys of other models such as OpenAI, Azure OpenAI, OpenRouter, etc.
</div>

[Click to learn more](http://localhost:3000/zh-CN/change-log)
...
<Image
  src="/change-log/v0.8.4-1-zh-en.png"
  alt="Cloud Sync"
  width={1034}
  height={1034}
/>
...
<Image
  src="/change-log/v0.8.3-1-en.png"
  alt="Project link"
  width={1300}
  height={731}
/>
...
<div className="flex gap-2">
  <Image
    src="/change-log/v0.7.3-1.jpg"
    alt="Project link"
    width={1920}
    height={1440}
  />
  <Image
    src="/change-log/v0.7.3-3.jpg"
    alt="Project link"
    width={1920}
    height={1440}
  />
...
<div className="flex gap-2">
  <Image
    src="/change-log/v0.7.1-1.png"
    alt="Project link"
    width={1920}
    height={1080}
  />
  <Image
    src="/change-log/v0.7.1-2.png"
    alt="Project link"
    width={1920}
    height={1080}
  />
