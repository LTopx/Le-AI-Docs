...
Insert the obtained `API key` into Le-AI plugin configuration and enable "Google Search" in order to use it.
...
To use, simply fill in the obtained "Google Search Engine ID" and "Google Search API Key" into the Le-AI plugin configuration, and enable Google search.
